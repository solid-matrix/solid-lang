...
/**
 * @brief The diagnostic chain: generated by LIST_DECLARE(SyntaxErrorList,
 *        syntax_errorlist, SyntaxError) — persistent and pure. head is the
 *        newest diagnostic, tail the rest of the chain.
 */
LIST_DECLARE(SyntaxErrorList, syntax_errorlist, SyntaxError);
