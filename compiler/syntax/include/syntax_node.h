...
/**
 * @brief A persistent list of AST nodes: generated by
 *        LIST_DECLARE(SyntaxNodeList, syntax_nodelist, SyntaxNode *);.
 *        head is the entry's node, tail the rest of the list.
 */
LIST_DECLARE(SyntaxNodeList, syntax_nodelist, SyntaxNode *);
